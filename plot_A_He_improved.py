...
summary_text = f"""A_He (ALPHA PARTICLE ABUNDANCE)
...
Z-ORDER RENDERING:
✓ Reference lines drawn BELOW histograms
✓ Higher contrast colors for visibility
✓ Grid behind all elements
"""
...
plt.suptitle('A_He Ultra-High-Resolution Analysis (Improved Z-Order)',
