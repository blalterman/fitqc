...
print("  Expected: lower_stickiness=True, upper_stickiness=False")
...
if result_default.lower_pileup_detected:
    print("  ✓ SUCCESS: Detected lower boundary pileup!")
else:
    print("  ✗ FAILED: Did not detect lower boundary pileup")
