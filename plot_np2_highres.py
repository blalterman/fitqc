...
print(f"Generating high-resolution plots for np2...")
...
ax1.set_title(f'np2 Raw Distribution (1000 bins)\n{len(x_valid):,} samples in [{L}, {U}]', fontsize=13, fontweight='bold')
...
ax2.set_title(f'np2 Near Lower Boundary (zoomed)\nFirst 10% of range: [{L:.2f}, {range_10pct:.2f}]', fontsize=13, fontweight='bold')
