...
print(f"Generating ultra-high-resolution plots for A_He...")
...
counts_full, edges_full, _ = ax1.hist(x, bins=bins_raw_full, color='steelblue', edgecolor='none', alpha=0.7)
...
if len(u_zoom_extreme_lower) > 0:
    ax6.hist(u_zoom_extreme_lower, bins=bins_u_extreme_lower, color='darkred', edgecolor='none', alpha=0.7)
...
plt.suptitle('A_He Ultra-High-Resolution Analysis (>2000 bins)',
