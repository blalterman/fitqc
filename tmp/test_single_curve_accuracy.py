...
print(f"Relative error: {100 * abs(result1.t_lo_star - true_threshold_norm) / true_threshold_norm:.1f}%")
...
print(f"Relative error: {100 * abs(result2.t_lo_star - true_threshold_norm2) / true_threshold_norm2:.1f}%")
...
print(f"Relative error: {100 * abs(result3.t_lo_star - true_threshold_norm3) / true_threshold_norm3:.1f}%")
